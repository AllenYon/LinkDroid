...
public final class DisplayImageOptions {
    ...
    private final Bitmap.CompressFormat mImageCompressFormat;
    ...
    public final ImageSize mTargetSize;
    public final ViewScaleType mViewScalType;
    ...
    private DisplayImageOptions(Builder builder) {
        ...
        mImageCompressFormat = builder.mImageCompressFormat;
        mImageQuality = builder.mImageQuality;
    ...
    public Bitmap.CompressFormat getImageCompressFormat() {
        return mImageCompressFormat;
    }
    ...
    public static class Builder {
        ...
        public Builder setImageCompressFormat(Bitmap.CompressFormat mImageCompressFormat) {
            this.mImageCompressFormat = mImageCompressFormat;
            return this;
        }

        public Builder setImageQuality(int mImageQuality) {
